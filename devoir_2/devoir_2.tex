...
%question 1
%======================================================
\begin{question}{Une question d’échauﬀement}
...
$$d\vec E = \frac{1}{4\pi\varepsilon_0} \frac{\rho\,dV\,(\vec r-\vec r\,')}{|\vec r-\vec r\,'|^3},$$
Donc

$$d\vec E = -\frac{\rho}{4\pi\varepsilon_0} \frac{\vec r\,'}{|\vec r\,'|^3}\,dV.$$
